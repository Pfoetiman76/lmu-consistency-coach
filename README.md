...
## Sprachausgabe: natürliche Stimme (Piper)

Vollständig offline. Einmalig einrichten:

1. Piper holen (`pip install piper-tts` oder Binary von **OHF-Voice/piper1-gpl**).
2. Deutsche Stimme **de_DE-thorsten** (`.onnx` **und** `.onnx.json` im selben Ordner).
3. In der App: **„Natürliche Stimme (Piper)…"** → piper-Programm und `.onnx` wählen.
