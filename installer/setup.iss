...
; 0.4.8.4: Piper-Binary + deutsche Thorsten-High-Stimme direkt aus dem CI-Ordner mitinstallieren
; (spec-unabhaengig; tts.py erkennt {app}\piper automatisch)
Source: "..\piper\*"; DestDir: "{app}\piper"; Flags: recursesubdirs createallsubdirs ignoreversion skipifsourcedoesntexist
