...
class Main(QMainWindow):
    def __init__(self):
        ...
        self.global_hotkey_state = {"F6": False, "F7": False, "F8": False, "F9": False, "F10": False, "F11": False}
...
"""
    ...
    def setup_hotkeys(self):
        ...
        self.log.append("App-Hotkeys aktiv: F6 Reifen-Overlay · F7 Auto-Bestlap AN/AUS · F8 Recording Start/Stop · F9 Snapshot · F10 Coach-Overlay · F11 Live-Coach")
    ...
    def poll_windows_hotkeys(self):
        # VK codes: F6=0x75, F7=0x76, F8=0x77, F9=0x78, F10=0x79, F11=0x7A
        mapping = {"F6": 0x75, "F7": 0x76, "F8": 0x77, "F9": 0x78, "F10": 0x79, "F11": 0x7A}
