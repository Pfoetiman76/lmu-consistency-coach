...
class TrackMapWidget(QWidget):
    def __init__(self):
        ...
        self.heat_metric = "delta"  # 0.4.8.8: "delta" | "pedal"
        self.setMinimumHeight(260)

    def set_heat_metric(self, metric):
        self.heat_metric = "pedal" if metric == "pedal" else "delta"
        self.update()
...
class Main(QMainWindow):
    def __init__(self):
        ...
        self.heatmap_metric_combo.currentIndexChanged.connect(
            lambda i: self.heatmap.set_heat_metric("pedal" if i == 1 else "delta"))
