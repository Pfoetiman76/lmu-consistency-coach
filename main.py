...
class Main(QMainWindow):
    def __init__(self):
        ...
        subtitle = QLabel("0.4.8.1 Beta – UI-Feinschliff")
        ...
        self.btn_overlays.setStyleSheet(
            "QToolButton { background:#171e29; color:#e8edf4; border:1px solid #262f3d; "
            "padding:9px 16px; border-radius:10px; font-weight:600; } "
            "QToolButton:hover { background:#1e2733; } "
...
"""
    ...
    def apply_theme(self, mode):
        ...
        self._root.setStyleSheet(LIGHT_QSS if self._theme == "light" else DARK_QSS)
