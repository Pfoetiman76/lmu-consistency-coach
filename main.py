...
class Main(QMainWindow):
    def __init__(self):
        ...
        title.setStyleSheet("font-size:27px;font-weight:800;color:#ffffff;letter-spacing:0.5px;")
        subtitle = QLabel("0.4.8.0 Beta – Piper-Stimme integriert · moderne UI")
